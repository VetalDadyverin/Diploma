    ...
    GroupBox {
        ...
        Row {
            ...
            Item{
                ...
                Image {
                    id: pic1
                    source : button__1 ?  adress : "file:///D:/Diploma/Diploma/Diploma/boat.jpg"
            ...
            Item{
                ...
                Image {
                    id: pic2
                    source : button__2 ?  "file:///D:/Diploma/Diploma/Diploma/_result_.jpg"/*"file:///D:/Diploma/Diploma/Diploma/_result_." + file_name2*/ : "file:///D:/Diploma/Diploma/Diploma/boat.png"
                    visible : true //hidden by default
                    anchors.fill : parent
        ...
        Row {
                    ...
                    ToggleButton{
                        ...
                        //anchors.left : rowBox2.left
                        text : "Haar Cascade Face Detector"
                    ...
                    ToggleButton{
                        ...
                        //anchors.right : rowBox2.right
                        height : rowBox2.height * 0.2
                        text : "DNN Cascade Face Detector"
                        onClicked : {
                            if (buff1) {
                ...
                Rectangle{
                    ...
                    MouseArea{
                        ...
                        onClicked: {
                            ...
                            button__1 = false
                            if(!buff1){
                                CppClass.dnnSlot(file_name1);
                                adress = file_name1 + "_dnn." + file_name2
                                button__1 = true
                                console.log("adress = " + adress)
                            }
                            else{
                                if(!buff){
                                    CppClass.haarSlot(file_name1);
                                    adress = file_name1 + "_haar." + file_name2
                                    button__1 = true
                                }
                            }
                        }
