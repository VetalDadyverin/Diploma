...
inline void drawBoundingBox(Mat image, vector<Point2f> bb)
{
...
inline void drawStatistics(Mat image, const Stats& stats)
{
...
inline void printStatistics(string name, Stats stats)
{
    cout << name << endl;
    cout << "----------" << endl;
...
inline vector<Point2f> Points(vector<KeyPoint> keypoints)
{
    vector<Point2f> res;
